...
export default function SignupPage() {
  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      ...
      <button
        onClick={() => signIn("google", { callbackUrl: "/explain" })}
        className="w-full flex items-center justify-center gap-2 border border-border rounded-lg py-2.5 text-sm hover:bg-accent transition-colors"
      >
